...
/**
 * Mezza Wallet payment method
 */
class WC_Payment_Gateway_Cowpay_Meeza_wallet extends WC_Payment_Gateway_Cowpay
{
    ...
    function __construct()
    {
        ...
        $this->id = "cowpay_meeza_wallet";

        // The Title shown on the top of the Payment Gateways Page next to all the other Payment Gateways
        $this->method_title = esc_html__("Cowpay Meeza Wallet", 'woo-cowpay');

        // The description for this Payment Gateway, shown on the actual Payment options page on the backend
        $this->method_description = esc_html__("Cowpay Pay Using Meeza Wallet Payment Gateway for WooCommerce", 'woo-cowpay');

        // The title to be used for the vertical tabs that can be ordered top to bottom
        $this->title = esc_html__("Cowpay Meeza Wallet", 'woo-cowpay');
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default'    => __('Meeza Wallet', 'woo-cowpay'),
            ),
            'description' => array(
                ...
                'default'    => __('Pay using Meeza Wallet', 'woo-cowpay'),
                'css'        => 'max-width:350px;'
            ),
        );
    }
    ...
    public function process_payment($order_id)
    {
        ...
        if (empty($messages)) { // success
            ...
            $_SESSION['walletDetails'] = $response;// An array
            WC()->cart->empty_cart();
